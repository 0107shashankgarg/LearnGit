...
public class TS_806615_VerifyFrgPassLinkClickable  {
	String enviornment;	
	public TS_806615_VerifyFrgPassLinkClickable(String enviornment) {
	...
	public void execute() {				
		...
		//Assert.assertTrue(screen.IsForPassEnableClickable());
