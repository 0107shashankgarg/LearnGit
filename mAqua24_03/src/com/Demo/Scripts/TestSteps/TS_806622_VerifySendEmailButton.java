...
public class TS_806622_VerifySendEmailButton  {
	String enviornment;	
	public TS_806622_VerifySendEmailButton(String enviornment) {
	...
	public void execute() {				
		...
		Assert.assertTrue(screen.IsSendEmailButtonPresent());
